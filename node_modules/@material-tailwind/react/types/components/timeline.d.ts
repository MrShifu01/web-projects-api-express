...
export declare const propTypeClassName: any;
export declare const propTypeChildren: any;
export declare const propTypeColor: any;
export declare const propTypeVariant: any;
